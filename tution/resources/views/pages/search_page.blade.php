...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <div class="relative flex items-top justify-center  bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            @endif
            <div id="custom-sticky" class="header header-sticky margin-top-0 margin-bottom-10" style="position:relative; background: #fafafa;">
                        <div id="searchFilterDiv" class="" style="background-color: rgb(250, 250, 250);">
                            <div class="text-center">
                                <h1 id="pageHeading" class="margin-top-10">
                                    <span id="pageTitle" style="font-family: Arial, &quot;Helvetica Neue&quot;, Helvetica, sans-serif;">Find teachers and home tutors for free</span>
                            ...
                            <form method="post" action="{{route('searchforteacher')}}" class="form-inline sky-form- page-search-form  " id="searchLocationForm" style="margin: 0 auto; display: table; background-color: #fafafa; border-bottom:none; padding: 0px;">
                                ...
                                <div class="inline-group  inline">
                                    <input data-hj-whitelist="" id="requireclass" class="form-control tooltips width-auto display-inline-block searchInputWidth xxs-full-width pac-target-input" type="text"  name="requireclass" placeholder="Enter Class/Subject"  data-toggle="tooltip" data-placement="top"  style="width: 284px !important;"><br>
                                    <input data-hj-whitelist="" id="location" class="form-control tooltips width-auto display-inline-block searchInputWidth xxs-full-width pac-target-input" type="text"  name="location" placeholder="Enter Location"  data-toggle="tooltip" data-placement="top" autocomplete="off" style="width: 284px !important;"><br>
