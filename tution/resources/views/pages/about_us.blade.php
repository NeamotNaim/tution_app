...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <div class="relative flex items-top justify-center py-4 bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            @if (Route::has('login'))
                <div class=" hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    @else
                        ...
                        <a href="{{ route('login') }}" class="p-2 text-sm text-gray-700 dark:text-gray-500 bold" style="background-color:rgb(204, 203, 203);color:rgb(3, 0, 0);border-radius:6px; border:2px solid  blue" >Teacher Login</a>

                        @if (Route::has('register'))
                        
                            <a href="{{ route('register') }}" class="p-2 p-1 ml-4 text-sm text-gray-700 dark:text-gray-500 " style="background-color:rgb(204, 203, 203);color:rgb(3, 0, 0);border-radius:6px; border:2px solid  blue">Teacher Register</a>
                        @endif
                    @endauth
                        ...
                        <div class="p-6">
                            ...
                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                     ...
                                     Our vision is to provide quality education to every student and ensure his/her success. We commit ourselves to excellent education and cherish the tutors who are fully dedicated and committed to instilling trust and compassion between teachers and students and ensuring that the students will achieve all their academic goals.
                                </div>
                            </div>
                        </div>
