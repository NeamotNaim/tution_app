...
<div class="container "  >
            <div class="menubar py-2">
                <nav class="navbar navbar-expand-lg navbar-light nav-sticky fs-5 ">
                    ...
                    <div class="p-2  " style="border-radius: 10px; color:#fff;background-color:#16A085;border:2px solid  blue;">
                    ...
                    <ul class="navbar-nav m-auto text-center ">
                        <li class="nav-item active " style=" margin-left:5px; background-color:rgb(204, 203, 203); border:2px solid  #727CF5; border-radius: 5px; color:rgb(0, 0, 0)">
                            <a class="nav-link mr-4" href="{{url('/')}}">Home<span class="sr-only"></span></a>
                        </li>
                        <li class="nav-item mr-4" style="margin-left:5px; background-color:rgb(204, 203, 203);border:2px solid  #727CF5; border-radius: 5px; color:rgb(0, 0, 0)">
