            ...
            <div class="collapse navbar-collapse " id="navbarSupportedContent">
                <ul class="navbar-nav m-auto text-center ">
                    <li class="nav-item active "
                        style=" margin-left:5px; background-color:rgb(204, 203, 203); border:2px solid  #727CF5; border-radius: 5px; color:rgb(0, 0, 0)">
                ...
                {{-- <form class="form-inline my-2 my-lg-0">
                    ...
                    <button class=" search-btn btn btn-basic-success my-2 my-sm-0" type="submit"><i
